...
![图片](https://mmbiz.qpic.cn/mmbiz_png/TNUwKhV0JpTndIZmc0Dpia2La90agmQib1jR8qibVG89yvgEevSakoEtiavyGWNibFf7CiahEWKdplnc6EGlMCMz80NQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

 [写数据底层原理](https://doocs.gitee.io/advanced-java/#/./docs/high-concurrency/es-write-query-search?id=写数据底层原理)
...
- `coordinate node` 返回 document 给客户端。
  ...
  ### [es 搜索数据过程](https://doocs.gitee.io/advanced-java/#/./docs/high-concurrency/es-write-query-search?id=es-搜索数据过程)
...
### [删除/更新数据底层原理](https://doocs.gitee.io/advanced-java/#/./docs/high-concurrency/es-write-query-search?id=删除更新数据底层原理)
